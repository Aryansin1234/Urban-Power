      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-muted-foreground text-sm sm:text-base">
              <li>
          ...
          <div>
            ...
            <div className="flex mt-4 space-x-4">
              <Link href="#" className="text-muted-foreground transition-colors">
                <Twitter className={styles["animated-social-icon"] + " h-6 w-6 sm:h-8 sm:w-8"} />
              </Link>
              <Link href="#" className="text-muted-foreground transition-colors">
                <Facebook className={styles["animated-social-icon"] + " h-6 w-6 sm:h-8 sm:w-8"} />
              </Link>
              <Link href="#" className="text-muted-foreground transition-colors">
                <Linkedin className={styles["animated-social-icon"] + " h-6 w-6 sm:h-8 sm:w-8"} />
              </Link>
            </div>
          </div>
        </div>
        <div className="mt-8 border-t border-border/50 pt-8 text-center text-muted-foreground text-sm sm:text-base">
